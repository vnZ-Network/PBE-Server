...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07498000000")
//     BC("chat", "player", -1, "GUID:07498000001")
//     return
//  endif
  
  if $is_rookie == 1
     BC("screen", "player", -1, "You've already received a BOI Rookie Card Divine Deity Chest. You can only use once.")
     BC("chat", "player", -1, "You've already received a BOI Rookie Card Divine Deity Chest. You can only use once.")
     return
  endif
  ...
  if $value == 14
     BC("screen", "player", -1, "You've already received a Duowan Citizen Celestial Prestige Chest. You can only receive one!")
     BC("chat", "player", -1, "You've already received a Duowan Citizen Celestial Prestige Chest. You can only receive one!")     
     return
  endif
