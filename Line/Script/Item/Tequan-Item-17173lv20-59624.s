	...
	//		Modified:2011/04/09
	//		Author:???
	//		TaskName:Tequan-Item-17173lv20-59624.s
	//		TaskID:4????
	//
	//****************************************
...
function OnUseItem(){
  ...
  //???????
  $del_count = SubPlayerInfo( -1, "item", 59624, 1 )
  //??????????
  if $del_count != 0
     return
  endif
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36653, 1)
  else 
     AddPlayerInfo(-1, "item", 36652, 1)
  endif
