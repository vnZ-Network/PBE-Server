	...
	//		Modified:2009/09/22
	//		Author:???
	//		TaskName:ITEM-tianxieka-63398.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63398, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Scorpio Card with a Starwish Charm, and has acquired the constellation pet: Scorpio." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Scorpio Card with a Starwish Charm, and has acquired the constellation pet: Scorpio." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Scorpio Card with a Starwish Charm, and has acquired the pet skill book: Scorpio Sting." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Scorpio Card with a Starwish Charm, and has acquired the pet skill book: Scorpio Sting." )
