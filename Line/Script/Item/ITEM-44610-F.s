	...
	function OnUseItem(){
		...
		if $time == $nowtime
			...
			if $round < 1000
				...
				//????
				$del = SubPlayerInfo( -1, "item", 44610, 1 )
				if $del != 0
					return
				endif
			...
			$round = $round + 1
				...
				BC( "screen", "player", -1, "Every day you can use 1000 Gold Coin Packs. You have used",$round,"of them." )
			...
			BC( "screen", "player", -1, "Every day you can use 1000 Gold Coin Pack. Now you have used the first one." )
