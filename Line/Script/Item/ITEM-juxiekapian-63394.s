	...
	//		Modified:2009/6/17
	//		Author:??
	//		TaskName:ITEM-juxiekapian-63394.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63394, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Cancer Card with a Starwish Charm, and has acquired the constellation pet: Cancer." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Cancer Card with a Starwish Charm, and has acquired the constellation pet: Cancer." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Cancer Card with a Starwish Charm, and has acquired the pet skill book: Cancer Judgment." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Cancer Card with a Starwish Charm, and has acquired the pet skill book: Cancer Judgment." )
