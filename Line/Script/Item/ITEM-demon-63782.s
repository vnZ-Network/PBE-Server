	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63782, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $random_item_2 <= 2
				...
				BC("screen", "servergroup", -1, "The hero ",#name,"Used Devil's Smile, you got Stardust Coin." )
				BC("chat", "servergroup", -1, "The hero ",#name,"Used Devil's Smile, you got Stardust Coin." )
			endif
			
			if $random_item_2 > 2
				if $random_item_2 <= 3
					AddPlayerInfo( -1, "item", 62073, 1 )
					#name = GetPlayerInfo(-1 , "name")
					BC("screen", "servergroup", -1, "The hero ",#name,"Used Devil's Smile, you got the Elite Combat Mount, Night Wings" )
					BC("chat", "servergroup", -1, "The hero ",#name,"Used Devil's Smile, you got the Elite Combat Mount, Night Wings" )
				endif
			endif
