	...
	//		Modified:2010/01/20
	//		Author:???
	//		TaskName:ITEM-baiyangka-63403.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63403, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has acquired the constellation pet: Aries. " )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has acquired the constellation pet: Aries. " )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has obtained the Pet Skillbook: Aries Nebula." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has obtained the Pet Skillbook: Aries Nebula." )
			...
			if $random_item_2 <= 2
				AddPlayerInfo( -1, "item", 60610, 1 )
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has acquired the pet skill book: Aries Nebula." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Aries Card with a Starwish Charm, and has acquired the pet skill book: Aries Nebula." )
			endif
