	...
	//		Modified:2010/01/20
	//		Author:???
	//		TaskName:ITEM-shuangyuka-63402.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63402, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Pisces Card with a Starwish Charm, and has acquired the pet: Pisces." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Pisces Card with a Starwish Charm, and has acquired the pet: Pisces." )
			...
			if $random_item_2 <= 2
				AddPlayerInfo( -1, "item", 60609, 1 )
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Pisces Card with a Starwish Charm, and has acquired the pet skill book: Pisces Rotation." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Pisces Card with a Starwish Charm, and has acquired the pet skill book: Pisces Rotation." )
			endif
