	...
	//		Modified:2009/09/22
	//		Author:???
	//		TaskName:ITEM-tianpingka-63397.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63397, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Libra Card with a Starwish Charm, and has acquired the constellation pet: Libra." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Libra Card with a Starwish Charm, and has acquired the constellation pet: Libra." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Libra Card with a Starwish Charm, and has acquired the pet skill book: Libra's Favor." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Libra Card with a Starwish Charm, and has acquired the pet skill book: Libra's Favor." )
