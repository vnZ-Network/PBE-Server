	...
	//		Modified:2009/09/22
	//		Author:???
	//		TaskName:ITEM-sheshouka-63399.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63399, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm, and has acquired the constellation pet: Sagittarius." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm, and has acquired the constellation pet: Sagittarius." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm and has acquired the Sniper Pet Skillbook." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm and has acquired the Sniper Pet Skillbook." )
			...
			if $random_item_2 <= 2
				AddPlayerInfo( -1, "item", 60604, 1 )
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm, and has acquired the pet skill book: Sniper." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Sagittarius Card with a Starwish Charm, and has acquired the pet skill book: Sniper." )
			endif
