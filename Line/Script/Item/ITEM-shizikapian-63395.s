	...
	//		Modified:2009/7/17
	//		Author:??
	//		TaskName:ITEM-shizikapian-63395.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63395, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Leo Card with a Starwish Charm, and has acquired the constellation pet: Leo." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Leo Card with a Starwish Charm, and has acquired the constellation pet: Leo." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Leo Card with a Starwish Charm, and has acquired the pet skill book: Leo Conscious." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Leo Card with a Starwish Charm, and has acquired the pet skill book: Leo Conscious." )
