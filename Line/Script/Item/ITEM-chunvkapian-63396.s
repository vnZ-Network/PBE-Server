	...
	//		Modified:2009/7/17
	//		Author:??
	//		TaskName:ITEM-chunvkapian-63396.s
	//		TaskID:???????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63396, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Virgo Card with a Starwish Charm, and has acquired the constellation pet: Virgo." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Virgo Card with a Starwish Charm, and has acquired the constellation pet: Virgo." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Virgo Card with a Starwish Charm, and has acquired the pet skill book: Virgo Prayer." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Virgo Card with a Starwish Charm, and has acquired the pet skill book: Virgo Prayer." )
