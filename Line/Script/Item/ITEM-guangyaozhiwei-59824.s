	...
	//		Modified:2011/06/10
	//		Author:???
	//		TaskName:ITEM-guangyaozhiwei-59824.s
	//		TaskID:????????
	//
	//****************************************
	//64266	?????
	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 59824, 1 )
		//??????????
	...
	function Random1(){
		...
		$random_item_2 = RandomNumber( 1, 10000 )
			...
			if $random_item_2 <= 1
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the constellation pet: Ninetail Fox" )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the constellation pet: Ninetail Fox" )
			endif
			...
			if $random_item_2 > 1
				if $random_item_2 <= 2
					...
					#name = GetPlayerInfo(-1 , "name")
					BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the rare item: Pet Skill Removal Charm" )
					BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the rare item: Pet Skill Removal Charm" )
				endif
			endif
			...
			if $random_item_2 > 3
				if $random_item_2 <= 5
					...
					#name = GetPlayerInfo(-1 , "name")
					BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the rare item: White Tiger Core" )
					BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Shining Force with a Starwish Charm, and has obtained the rare item: White Tiger Core" )
				endif
			endif
