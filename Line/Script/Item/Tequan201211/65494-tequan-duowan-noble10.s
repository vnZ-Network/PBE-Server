	...
	//		Author:???(??,??,??)
	//		TaskName:2012?8???????????10???
	//		TaskID:44301-tequan-duowan-noble10.s
	//
	//****************************************
...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07545000000")
//     BC("chat", "player", -1, "GUID:07545000001")
//     return
//  endif
...
//  $del_count = SubPlayerInfo( -1, "item", 44301, 1 )
  //??????????,????????
  if $del_count != 0
     return
  endif
...
//  AddPlayerInfo(-1, "item", 44302, 1 ) 
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36141, 1)
  else 
     AddPlayerInfo(-1, "item", 36140, 1)
  endif
