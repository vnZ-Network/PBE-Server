...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07569000000")
//     BC("chat", "player", -1, "GUID:07569000001")
//     return
//  endif
...
//  $del_count = SubPlayerInfo( -1, "item", 44332, 1 )
  //??????????,????????
  if $del_count != 0
     return
  endif
...
//  AddPlayerInfo(-1, "item", 44333, 1 ) 
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36157, 1)
  else 
     AddPlayerInfo(-1, "item", 36156, 1)
  endif
