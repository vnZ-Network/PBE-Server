...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07583000000")
//     BC("chat", "player", -1, "GUID:07583000001")
//     return
//  endif
...
//  $del_count = SubPlayerInfo( -1, "item", 44338, 1 )
  ...
  //???2012?17173,??11
  SetPlayerVar(-1, 3424, 20)

  //---------?????????------------
  
	//?????????
  AddPlayerInfo(-1, "item", 44586, 1 ) 
  
  //????,??????Buff
  PlayEffect(-1, "common\Yanhua\tx_liuxingyu\tx_liuxingyu.ini" )
  AddStatus(-1, 7583, 1 )
  AddTitle( -1, 93 )
  BC("messagebox","player",-1,"Acquire a new Title: Eternal Celestial")
//62600	????????????
//44361	??????
//59141	?????
//59080	?????
