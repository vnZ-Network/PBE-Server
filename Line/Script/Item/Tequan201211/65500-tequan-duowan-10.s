	...
	//		Author:???(??,??,??)
	//		TaskName:2012?4???????????10???
	//		TaskID:44308-tequan-duowan-10.s
	//
	//****************************************
...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07551000000")
//     BC("chat", "player", -1, "GUID:07551000001")
//     return
//  endif
...
//  $del_count = SubPlayerInfo( -1, "item", 44308, 1 )
  //??????????,????????
  if $del_count != 0
     return
  endif
...
//  AddPlayerInfo(-1, "item", 44309, 1 ) 
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36145, 1)
  else 
     AddPlayerInfo(-1, "item", 36144, 1)
  endif
