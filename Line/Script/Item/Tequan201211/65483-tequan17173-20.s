	...
	//		Modified:2012/03/15
	//		Author:???(??,??,??)
	//		TaskName:2012?8??????17173?20???
	//		TaskID:44288-tequan17173-20.s
	//
	//****************************************
...
//  $del_count = SubPlayerInfo( -1, "item", 44288, 1 )
  //??????????,????????
  if $del_count != 0
     return
  endif
...
//  AddPlayerInfo(-1, "item", 44289, 1 ) 
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36135, 1)
  else 
     AddPlayerInfo(-1, "item", 36134, 1)
  endif
