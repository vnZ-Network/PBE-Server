	...
	//		Author:???(??,??,??)
	//		TaskName:2012?8???????????10???
	//		TaskID:44294-tequan-duowan-royalty10.s
	//
	//****************************************
...
//  if $is_used_guild == 1
//     BC("screen", "player", -1, "GUID:07539000000")
//     BC("chat", "player", -1, "GUID:07539000001")
//     return
//  endif
...
//  $del_count = SubPlayerInfo( -1, "item", 44294, 1 )
  //??????????,????????
  if $del_count != 0
     return
  endif
...
//  AddPlayerInfo(-1, "item", 44295, 1 ) 
  ...
  if $gender == 0
     AddPlayerInfo(-1, "item", 36137, 1)
  else 
     AddPlayerInfo(-1, "item", 36136, 1)
  endif
