	...
	function OnUseItem(){
		...
		//????
		$del_count = SubPlayerInfo( -1, "item", 63400, 1 )
		//??????????
		...
		if $del_count == 0
			...
			if $use_number_jinniu == $give_number_jinniu
				...
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm, and has acquired the constellation pet: Capricorn." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm, and has acquired the constellation pet: Capricorn." )
			...
			if $use_number_paoxiaoshu == $give_number_paoxiaoshu
				...
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm and has acquired the Capricorn Domineer Pet Skillbook." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm and has acquired the Capricorn Domineer Pet Skillbook." )
			...
			if $random_item_2 <= 2
				AddPlayerInfo( -1, "item", 60607, 1 )
				#name = GetPlayerInfo(-1 , "name")
				BC("screen", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm, and has acquired the pet skill book: Capricorn Domineer." )
				BC("chat", "servergroup", -1, "The hero ",#name," has blessed the Capricorn Card with a Starwish Charm, and has acquired the pet skill book: Capricorn Domineer." )
			endif
