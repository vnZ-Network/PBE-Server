	...
	//		Modified:2010/01/29
	//		Author:???
	//		TaskName:97-jianzhong-item-12752.s
	//		TaskID:  XXX
	//
	//****************************************
...
//		endif
		...
		if $posx < 84
			BC( "screen" , "player" , -1 , "Can't summon Baberet's soul here" )
			BC( "chat" , "player" , -1 , "Can't summon Baberet's soul here" )
			return
		endif
		if $posx > 99
			BC( "screen" , "player" , -1 , "Can't summon Baberet's soul here"  )
		...
		$info = SubPlayerInfo ( -1 , "item" , 12752 , 1 )
		if  $info != 0
			return
		endif		
		...
		BC( "chat" , "player" , -1 , "Danger, Baberet's soul appears" )
		BC( "screen" , "player" , -1 , "Danger, Baberet's soul appears" )
		AddMonsterByFloat( 59103, 1 , $ectype_id , 92 , 71 , 0 )
