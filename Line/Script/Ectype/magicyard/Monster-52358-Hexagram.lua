...
--				AI:Say("")
				AI:ScreenText("Hayst: Beep, beep. Don't challenge the forces of darkness!",2)
			end
			if a == 2 then
				AI:DelTimer(1)
				AI:SetArray(9,1)
...
--				AI:ChangeFaction(11)
		    AI:SetArray(9,0)
--				AI:Say("")
				AI:ScreenText("Magic Array Released: Robot Hayst has been activated.",2)
			end
			a = AI:GetArray(2)
			if a == 0 then --????,????
