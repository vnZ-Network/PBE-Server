...
--				AI:Say("")
				AI:ScreenText("Jamir: Beep, beep. The strongest robot is beginning to fight.",2)
			end
			if a == 2 then
				AI:DelTimer(1)
				AI:SetArray(9,1)
...
--					if rand < 33 then--??1??--start
--						AI:ScreenText("",2)
						AI:Say("The most powerful weapon is to make your opponent feel helpless.")
--					else
--						if rand < 66 then
--							AI:ScreenText("",2)
--							AI:Say("")
...
--				end--??all--end
		...
		if nIndex == 3 then--????
			...
			if a == 1 then
				...
				AI:UseSkill(2327,1)
--				AI:ScreenText( "" , 2)
				AI:Say("The strongest robot has entered battle.")
			end
		end--????end
...
--				AI:ChangeFaction(11)
		    AI:SetArray(9,0)
--				AI:Say("")
				AI:ScreenText("Magic Array Released: Robot Jamir has been activated.",2)
			end
			a = AI:GetArray(2)
			if a == 0 then --????,????
