...
--				AI:Say("")
				AI:ScreenText("Marra: Beep, beep. I am Speed Robot Marra.",2)
			end
			if a == 2 then
				AI:DelTimer(1)
				AI:SetArray(9,1)
...
--				end--??all--end
		...
		if nIndex == 3 then--????
			...
			if a == 1 then
				...
				AI:UseSkill(2327,1)
--				AI:ScreenText( "" , 2)
				AI:Say("You are too slow. It is not even funny.")
			end
		end--????end
...
--				AI:ChangeFaction(11)
		    AI:SetArray(9,0)
--				AI:Say("")
				AI:ScreenText("Magic Array Released: Robot Marra has been activated.",2)
			end
			a = AI:GetArray(2)
			if a == 0 then --????,????
