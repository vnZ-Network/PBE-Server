	...
	//?????
	//????6?
		AddMonsterByFloat($guard_id, 1, $ectype_id, 272, 126, 0, 0, 0)
		AddMonsterByFloat($guard_id, 1, $ectype_id, 272, 128, 0, 0, 0)
		AddMonsterByFloat($guard_id, 1, $ectype_id, 272, 130, 0, 0, 0)
		AddMonsterByFloat($guard_id, 1, $ectype_id, 276, 126, 0, 0, 180)
		AddMonsterByFloat($guard_id, 1, $ectype_id, 276, 128, 0, 0, 180)
		AddMonsterByFloat($guard_id, 1, $ectype_id, 276, 130, 0, 0, 180)
				
	//??NPC???2?
		AddMonsterByFloat($guard_id_1, 1, $ectype_id, 299, 117, 0, 0, 90)
		AddMonsterByFloat($guard_id_1, 1, $ectype_id, 305, 117, 0, 0, 90)	
