	...
	function OnOption0(){
		...
		if $is_open != 0		
			BC("dialogbox", "player", -1, "The Seal activated a Mystery Defense, and can not be broken now.")
			return
		else
  		...
  		SetEctypeVar(-1, 48, 1)
  		BC("screen", "map", $ectype_id, "Imperial Seal summons monsters to defend itself!")
  	endif
