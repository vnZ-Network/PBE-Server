	...
	function OnDead(){
  	...
  	if $count == 2
    	...
    	BC("chat","player",-1,"The second defense of the Imperial Seal has activated. You must destroy the Tao of Cunning, the Tao of Might, and the Tao of Sovereignty to remove the seal.")
		  ...
		  AddMonsterByFloat($mst_jun, 1, $ectype_id, 255, 66, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 255, 75, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 259, 62, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 259, 80, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 266, 62, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 266, 78, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 271, 68, 0)
			AddMonsterByFloat($mst_jun, 1, $ectype_id, 271, 73, 0)
