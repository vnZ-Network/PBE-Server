	...
	function OnDead(){
		...
		BC( "screen" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the South Atlantic and opened the seal!"  )
		BC( "chat" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the South Atlantic and opened the seal!"  )
		...
		//AddMonsterByFloat( 51650 , 30 , 273 , 94 , 56 , 5 )
