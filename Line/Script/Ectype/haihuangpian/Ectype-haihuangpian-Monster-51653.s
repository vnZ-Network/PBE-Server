	...
	function OnDead(){
		...
		BC( "screen" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Arctic Ocean and opened the seal!"  )
		BC( "chat" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Arctic Ocean and opened the seal!"  )
		...
		//AddMonsterByFloat( 51650 , 30 , 273 , 268 , 106 , 5 )
		//AddMonster( 51650 , 30 , 273 , 105 , 41 , 5 )
