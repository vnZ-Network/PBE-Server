	...
	function OnDead(){
		...
		BC( "screen" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the North Atlantic and opened the seal!"  )
		BC( "chat" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the North Atlantic and opened the seal!"  )
		...
		//AddMonsterByFloat( 51650 , 30 , 273 , 166 , 51 , 5 )
