	...
	function OnDead(){
		...
		BC( "screen" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Indian Ocean and opened the seal!"  )
		BC( "chat" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Indian Ocean and opened the seal!"  )
		...
		//AddMonsterByFloat( 51650 , 30 , 273 , 39 , 96 , 5 )
