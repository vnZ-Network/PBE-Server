	...
	function OnDead(){
		...
		BC( "screen" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Antarctic Ocean and opened the seal!"  )
		BC( "chat" , "servergroup" , -1 , "The hero " , #name , " has destroyed the Pillar of the Antarctic Ocean and opened the seal!"  )
		...
		//AddMonsterByFloat( 51650 , 30 , 273 , 44 , 190 , 5 )
