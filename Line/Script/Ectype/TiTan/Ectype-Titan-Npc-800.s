	...
	//		Modified:2012-5-8
	//		Author:???
	//		TaskName:Ectype-Titan-Npc-800.s
	//		TaskID:??????
	//
	//****************************************
	//
...
//			DisableNpcOption(11)
//		endif
      $playervar = GetPlayerVar( -1, 4088 )
			$today_time = GetSystemTime( "yday" )
			if $playervar == $today_time
			  DisableNpcOption(2)
		  endif
		
			$Task = IsTaskAccept( -1, 1875 )
			if $Task == 0
			  DisableNpcOption(2)
		  endif
...
//				endif
//			else
//				BC( "dialogbox", "player", -1, "GUID:04663000000" )
//			endif
//		else
//			BC( "dialogbox", "player", -1, "GUID:04663000001" )
//		endif
			BC( "dialogbox", "player", -1, "Heh Heh Heh!" )
	}
...
//			endif
//		else
//			BC( "dialogbox", "player", -1, "GUID:04663000003" )
//		endif
			BC( "dialogbox", "player", -1, "Hahaha!" )
	}	
	...
	function OnOption2(){
		  ...
		  if $level < 115
			  BC( "dialogbox", "player", -1, "You must be LV115 to accept." )
			  return
		  endif
		  ...
		  AcceptTask( -1, 1875 )
		  SetPlayerVar( -1, 4088, $today_time )
...
//		if $used == 0
//			if $gfgf < 60000
//				BC( "dialogbox", "player" , -1 , "GUID:04663000071" )
//			else
//				AddTrump( -1 , 11009 , 1 )
//				SetPlayerVar( -1 , 125 , 1)
//				BC( "screen", "player", -1, "GUID:04663000072" )
//			endif
//		else
//			BC( "dialogbox", "player" , -1 , "GUID:04663000073" )
//		endif
//		
//	}