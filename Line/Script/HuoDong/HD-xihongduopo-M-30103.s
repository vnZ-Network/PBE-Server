	...
	//		Modified:2008/09/03
	//		Author:??
	//		TaskName:HD-xihongduopo-M-30103.s
	//		TaskID:????????-BOSS????
	//
	//****************************************
	...
	//????????????ID
		...
		BC( "chat", "server", -1, "The hero ",#player_name,"team defeat Khar Elite Guard in Angkor Jungle,got amount EXP and gold." )
		BC( "screen", "server", -1, "The hero ",#player_name,"team defeat Khar Elite Guard in Angkor Jungle,got amount EXP and gold."  )
		...
		if $teamplayer1_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer1_id, "GUID:05173000004", $add_exp ,"GUID:05173000005",$add_money)
		...
		if $teamplayer2_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer2_id, "GUID:05173000006", $add_exp ,"GUID:05173000007",$add_money)
		...
		if $teamplayer3_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer3_id, "GUID:05173000008", $add_exp ,"GUID:05173000009",$add_money)
		...
		if $teamplayer4_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer4_id, "GUID:05173000010", $add_exp ,"GUID:05173000011",$add_money)
		...
		if $teamplayer5_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer5_id, "GUID:05173000012", $add_exp ,"GUID:05173000013",$add_money)
		...
		if $teamplayer6_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer6_id, "GUID:05173000014", $add_exp ,"GUID:05173000015",$add_money)
