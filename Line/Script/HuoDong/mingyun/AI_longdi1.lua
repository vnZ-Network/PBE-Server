            ...
            if HP < HPMAX * 0.8 then
                ...
                AI:UseSkill(8616,3)
		            ...
		            AI:SummonMonsterByPos( 11970 , posx + 1 , posy + 1)
								AI:SummonMonsterByPos( 11970 , posx + 3 , posy + 1)
		            AI:SummonMonsterByPos( 11970 , posx + 2 , posy + 2)
								AI:SummonMonsterByPos( 11970 , posx + 1 , posy + 3)
		            AI:SummonMonsterByPos( 11970 , posx + 3 , posy + 3)
		            ...
		            AI:SummonMonsterByPos( 11970 , posx , posy - 4)
								AI:SummonMonsterByPos( 11970 , posx , posy)
		            AI:SummonMonsterByPos( 11970 , posx - 4 , posy)
								AI:SummonMonsterByPos( 11970 , posx , posy + 4)
