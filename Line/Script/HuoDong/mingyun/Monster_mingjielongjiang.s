	...
	//		Author:???
	//		TaskName:????
	//		TaskID:Monster_mingjielongjiang.s
	//
	//****************************************
	...
	function OnDead(){
		...
		$isteam = IsPlayerInTeam(-1)
			if $isteam == 0
				...
				if $num > 0
					...
					if $Men1 != -1
						...
						if $map1 == 86
							...
							$wanjia1 = $wanjia1 + 1000
							SetPlayerVar( $Men1 , 4030 , $wanjia1 )
							BC("screen","player",$Men1,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif	
					endif
					if $Men2 != -1
						...
						if $map2 == 86
							...
							$wanjia2 = $wanjia2 + 1000
							SetPlayerVar( $Men2 , 4030 , $wanjia2 )
							BC("screen","player",$Men2,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif
					endif
					if $Men3 != -1
						...
						if $map3 == 86
							...
							$wanjia3 = $wanjia3 + 1000
							SetPlayerVar( $Men3 , 4030 , $wanjia3 )
							BC("screen","player",$Men3,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif
					endif
					if $Men4 != -1
						...
						if $map4 == 86
							...
							$wanjia4 = $wanjia4 + 1000
							SetPlayerVar( $Men4 , 4030 , $wanjia4 )
							BC("screen","player",$Men4,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif
					endif
					if $Men5 != -1
						...
						if $map5 == 86
							...
							$wanjia5 = $wanjia5 + 1000
							SetPlayerVar( $Men5 , 4030 , $wanjia5 )
							BC("screen","player",$Men5,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif
					endif
					if $Men6 != -1
						...
						if $map6 == 86
							...
							$wanjia6 = $wanjia6 + 1000
							SetPlayerVar( $Men6 , 4030 , $wanjia6 )
							BC("screen","player",$Men6,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
						endif
					endif
				endif
			else
				...
				BC("screen","player",-1,"Your team killed the Nether Dragonlancer! Received 1,000 points!")
			endif
