	...
	//		Modified:2008/09/03
	//		Author:??
	//		TaskName:HD-xihongduopo-M-30102.s
	//		TaskID:????????-BOSS????
	//
	//****************************************
	...
	//????????????ID
		...
		BC( "chat", "server", -1, "The hero ",#player_name,"team defeat Khar Elite Guard in Atlantic,got amount EXP and gold." )
		BC( "screen", "server", -1, "The hero ",#player_name,"team defeat Khar Elite Guard in Atlantic,got amount EXP and gold."  )
		...
		if $teamplayer1_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer1_id, "GUID:05172000004", $add_exp ,"GUID:05172000005",$add_money)
		...
		if $teamplayer2_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer2_id, "GUID:05172000006", $add_exp ,"GUID:05172000007",$add_money)
		...
		if $teamplayer3_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer3_id, "GUID:05172000008", $add_exp ,"GUID:05172000009",$add_money)
		...
		if $teamplayer4_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer4_id, "GUID:05172000010", $add_exp ,"GUID:05172000011",$add_money)
		...
		if $teamplayer5_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer5_id, "GUID:05172000012", $add_exp ,"GUID:05172000013",$add_money)
		...
		if $teamplayer6_id != -1
			...
			//??1??????
				...
				//BC( "chat", "player", $teamplayer6_id, "GUID:05172000014", $add_exp ,"GUID:05172000015",$add_money)
