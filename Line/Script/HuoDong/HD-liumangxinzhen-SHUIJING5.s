	...
	//		Modified:2008/09/05
	//		Author:??
	//		TaskName:HD-liumangxinzhen-SHUIJING5.s
	//		TaskID:????-????NPC?????
	//
	//****************************************
	function OnRequest(){
	...
	//?????????
		...
		if $teamplayer1_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer1_id ,6)
			if $is_complete == 1
		...
		if $teamplayer2_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer2_id ,6)
			if $is_complete == 1
				BC( "dialogbox", "player",-1 ,"The hero ",#name," has already used a Music Gem here." )
				return
			endif
		...
		if $teamplayer3_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer3_id ,6)
			if $is_complete == 1
				BC( "dialogbox", "player",-1 ,"The hero ",#name," has already used a Music Gem here." )
				return
			endif
		...
		if $teamplayer4_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer4_id ,6)
			if $is_complete == 1
				BC( "dialogbox", "player",-1 ,"The hero ",#name," has already used a Music Gem here." )
				return
			endif
		...
		if $teamplayer5_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer5_id ,6)
			if $is_complete == 1
				BC( "dialogbox", "player",-1 ,"The hero ",#name," has already used a Music Gem here." )
				return
			endif
		...
		if $teamplayer6_id != -1
			...
			//??1????????
			$is_complete = GetPlayerVar($teamplayer6_id ,6)
			if $is_complete == 1
				BC( "dialogbox", "player",-1 ,"The hero ",#name," has already used a Music Gem here." )
				return
			endif
...
//						BC("screen", "player", $teamplayer1_id ,"GUID:05033000034")
//						BC("chat", "player", $teamplayer1_id ,"GUID:05033000035")
...
//						BC("chat", "player", $teamplayer2_id ,"GUID:05033000044")
//						BC("screen", "player", $teamplayer2_id ,"GUID:05033000045")
...
//						BC("chat", "player", $teamplayer3_id ,"GUID:05033000054")
//						BC("screen", "player", $teamplayer3_id ,"GUID:05033000055")
...
//						BC("chat", "player", $teamplayer4_id ,"GUID:05033000064")
//						BC("screen", "player", $teamplayer4_id ,"GUID:05033000065")
...
//						BC("chat", "player", $teamplayer5_id ,"GUID:05033000074")
//						BC("screen", "player", $teamplayer5_id ,"GUID:05033000075")
...
//						BC("chat", "player", $teamplayer6_id ,"GUID:05033000084")
//						BC("screen", "player", $teamplayer6_id ,"GUID:05033000085")
	...
	//?????????????????
	if $teamplayer1_id != -1
		SetPlayerVar($teamplayer1_id ,6 , 1)
		//??????????????
	...
	//--------------------------------------------------------------------------------------------------------------
	if $teamplayer2_id != -1
		SetPlayerVar($teamplayer2_id ,6 , 1)
		//??????????????
	...
	if $teamplayer3_id != -1
		SetPlayerVar($teamplayer3_id ,6 , 1)
	...
	if $teamplayer4_id != -1
		SetPlayerVar($teamplayer4_id ,6 , 1)
	...
	if $teamplayer5_id != -1
		SetPlayerVar($teamplayer5_id ,6 , 1)
	...
	if $teamplayer6_id != -1
		SetPlayerVar($teamplayer6_id ,6 , 1)
