	...
	//		Modified:2010/03/04
	//		Author:??
	//		TaskName:kuafu-Monster-guodu-59163.s
	//		TaskID: 
	//
	//****************************************
	...
	function OnDead(){
		...
		if $camp == 1
			#resname = SwapResourcePoint( $id , 59162, 1 )
		...
		#resname = SwapResourcePoint( $id , 59165 , 2 )
		BC( "screen", "map", $ectype_ID , "Sol occupies ", #resname, "." )
		
		if $line == 100
			AddMonsterByFloat ( 59037 , 2 , $ectype_ID , 108, 131 , 2 )
		else
			AddMonsterByFloat ( 59097 , 2 , $ectype_ID , 108, 131 , 2 )
		endif	
