	...
	//		Modified:2011/07/29
	//		Author:??
	//		TaskName:Xingpan-yigounengliangti.s
	//		TaskID:?????
	//****************************************
						...
						//??????????
							if $count1 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men1, "item", 59887, 1 )
									 endif
								endif
							endif
						endif
						...
						if $mapid2 == 44
							if $count2 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men2, "item", 59887, 1 )
									 endif
								endif
							endif
						endif
						...
						if $mapid3 == 44
							if $count3 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men3, "item", 59887, 1 )
									 endif
								endif
							endif
						endif
						...
						if $mapid4 == 44
							if $count4 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men4, "item", 59887, 1 )
									 endif
								endif								
							endif
						endif
						...
						if $mapid5 == 44
							if $count5 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men5, "item", 59887, 1 )
									 endif
								endif
								if $a < 95
						...
						if $mapid6 == 44
							if $count6 >= 1						
								...
								if $a < 95
									 ...
									 AddPlayerInfo ( $Men6, "item", 59887, 1 )
									 endif
								endif				
							endif
						endif
