//───────────────────────────────────────
//Phụ Bản:《"Đảo U Linh [3 Chế Độ]"》
//───────────────────────────────────────
	function OnRequest(){
		$Ins = GetEctypeID( -1, 222 )
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Specter Island (Normal)"
     #instanceVN = "Đảo U Linh (Thường)"
          $EctVar = 0
          $Dif = 0
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Specter Island (Hard)"
     #instanceVN = "Đảo U Linh (Khó)"
          $EctVar = 0
          $Dif = 1
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Specter Island (Nightmare)"
     #instanceVN = "Đảo U Linh (Địa Ngục)"
          $EctVar = 0
          $Dif = 2
