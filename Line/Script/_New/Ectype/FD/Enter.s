    ...
    //───────────────────────────────────
        ...
        if $succeed > 0
            ...
            if $today != $last
                ...
                SetPlayerVar(-1, $v_last, $succeed)
                StartEctypeTimer($mapID, 0)
                StartEctypeTimer($mapID, 8)
        ...
        if $Mem1 != -1
            if $Mem1 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem1, $v_last, $succeed)
        ...
        if $Mem2 != -1
            if $Mem2 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem2, $v_last, $succeed)  
        ...
        if $Mem3 != -1
            if $Mem3 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem3, $v_last, $succeed) 
        ...
        if $Mem4 != -1
            if $Mem4 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem4, $v_last, $succeed) 
        ...
        if $Mem5 != -1
            if $Mem5 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem5, $v_last, $succeed)
        ...
        if $Mem6 != -1
            if $Mem6 != $leaderID
                ...
                if $succeed > 0
                    ...
                    SetPlayerVar($Mem6, $v_last, $succeed)
