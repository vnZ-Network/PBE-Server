//───────────────────────────────────────
//Phụ Bản:《"Kim Tự Tháp [3 Chế Độ]"》
//───────────────────────────────────────
	function OnRequest(){
		$Ins = GetEctypeID( -1, 232 )
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Giza Pyramid (Normal)"
     #instanceVN = "Kim Tự Tháp (Thường)"
          $EctVar = 4
          $Dif = 0
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Giza Pyramid (Hard)"
     #instanceVN = "Kim Tự Tháp (Khó)"
          $EctVar = 4
          $Dif = 1
...
//───────────────────────────────────────
    ...
    //"Check Thông Số"
    //───────────────────────────────────
     #instanceEN = "Giza Pyramid (Nightmare)"
     #instanceVN = "Kim Tự Tháp (Địa Ngục)"
          $EctVar = 4
          $Dif = 2
