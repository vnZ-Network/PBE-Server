	...
	function OnOption0(){
		...
		if $stage == 1
			$stage0 = GetEctypeVar( -1, 116 )
			if $stage0 == 1
				FlyToMap( -1, $ectID, 61, 51 )
				return
			endif
			if $stage0 == 2
				FlyToMap( -1, $ectID, 66, 51 )				
				return
			endif
		endif
		...
		$stage0 = GetEctypeVar( -1, 1 )
		if $stage0 == 1
			FlyToMap( $mem1_id, $ectID, 61, 51 )
			FlyToMap( $mem2_id, $ectID, 61, 51 )
			FlyToMap( $mem3_id, $ectID, 61, 51 )
			FlyToMap( $mem4_id, $ectID, 61, 51 )
			FlyToMap( $mem5_id, $ectID, 61, 51 )
			FlyToMap( $mem6_id, $ectID, 61, 51 )
			SetEctypeVar( -1, 116, 1 )			
		else
			FlyToMap( $mem1_id, $ectID, 66, 51 )
			FlyToMap( $mem2_id, $ectID, 66, 51 )
			FlyToMap( $mem3_id, $ectID, 66, 51 )
			FlyToMap( $mem4_id, $ectID, 66, 51 )
			FlyToMap( $mem5_id, $ectID, 66, 51 )
			FlyToMap( $mem6_id, $ectID, 66, 51 )
	...
	if $stage0 != 1	
		...
		if $stage1 == 1
			if $stage2 == 2
				if $stage3 == 3
					if $Dif == 0
                              AddMonster( $s4mon1, 1, $ectID, 56, 47 , 0 )
                         endif
                         if $Dif == 1
                              AddMonster( $s4mon2, 1, $ectID, 47, 56 , 0 )
                         endif
                         if $Dif == 2
                              AddMonster( $s4mon3, 1, $ectID, 55, 55 , 0 )
                         endif
				endif
			endif
		endif
		...
		if $stage1 == 1
			if $stage2 == 2
				if $stage3 == 4
                         if $Dif == 0
                              AddMonster( $s3mon1, 20, $ectID, 56, 47 , 9 )
                              AddMonster( $s3mon1, 20, $ectID, 47, 56 , 9 )
                              AddMonster( $s3mon1, 10, $ectID, 55, 55 , 6 )
                         endif
                         if $Dif == 1
                              AddMonster( $s3mon2, 20, $ectID, 56, 47 , 9 )
                              AddMonster( $s3mon2, 20, $ectID, 47, 56 , 9 )
                              AddMonster( $s3mon2, 10, $ectID, 55, 55 , 6 )
                         endif
                         if $Dif == 2
                              AddMonster( $s3mon3, 20, $ectID, 56, 47 , 9 )
                              AddMonster( $s3mon3, 20, $ectID, 47, 56 , 9 )
                              AddMonster( $s3mon3, 10, $ectID, 55, 55 , 6 )
                         endif
				endif
			endif
		endif
		...
		if $stage1 == 1
			if $stage2 == 3
				if $stage3 == 4
                         if $Dif == 0
                              AddMonster( $s2mon11, 20, $ectID, 56, 47 , 10 )
                              AddMonster( $s2mon11, 20, $ectID, 47, 56 , 10 )
                              AddMonster( $s2mon11, 10, $ectID, 55, 55 , 6 )
                              $Rand = RandomNumber( 1, 5 )
                              if $Rand == 1
                                   AddMonster( $s2mon12, 1, $ectID, 56, 45 , 0 )
                              endif
                              if $Rand == 2
                                   AddMonster( $s2mon12, 1, $ectID, 56, 51 , 0 )
                              endif
                              if $Rand == 3
                                   AddMonster( $s2mon12, 1, $ectID, 51, 51 , 0 )
                              endif
                              if $Rand == 4
                                   AddMonster( $s2mon12, 1, $ectID, 47, 53 , 0 )
                              endif
                              if $Rand == 5
                                   AddMonster( $s2mon12, 1, $ectID, 47, 56 , 0 )
                              endif
                         endif
                         if $Dif == 1
                              AddMonster( $s2mon21, 20, $ectID, 56, 47 , 10 )
                              AddMonster( $s2mon21, 20, $ectID, 47, 56 , 10 )
                              AddMonster( $s2mon21, 10, $ectID, 55, 55 , 6 )
                              $Rand = RandomNumber( 1, 5 )
                              if $Rand == 1
                                   AddMonster( $s2mon22, 1, $ectID, 56, 45 , 0 )
                              endif
                              if $Rand == 2
                                   AddMonster( $s2mon22, 1, $ectID, 56, 51 , 0 )
                              endif
                              if $Rand == 3
                                   AddMonster( $s2mon22, 1, $ectID, 51, 51 , 0 )
                              endif
                              if $Rand == 4
                                   AddMonster( $s2mon22, 1, $ectID, 47, 53 , 0 )
                              endif
                              if $Rand == 5
                                   AddMonster( $s2mon22, 1, $ectID, 47, 56 , 0 )
                              endif
                         endif
                         if $Dif == 2
                              AddMonster( $s2mon31, 20, $ectID, 56, 47 , 10 )
                              AddMonster( $s2mon31, 20, $ectID, 47, 56 , 10 )
                              AddMonster( $s2mon31, 10, $ectID, 55, 55 , 6 )
                              $Rand = RandomNumber( 1, 5 )
                              if $Rand == 1
                                   AddMonster( $s2mon32, 1, $ectID, 56, 45 , 0 )
                              endif
                              if $Rand == 2
                                   AddMonster( $s2mon32, 1, $ectID, 56, 51 , 0 )
                              endif
                              if $Rand == 3
                                   AddMonster( $s2mon32, 1, $ectID, 51, 51 , 0 )
                              endif
                              if $Rand == 4
                                   AddMonster( $s2mon32, 1, $ectID, 47, 53 , 0 )
                              endif
                              if $Rand == 5
                                   AddMonster( $s2mon32, 1, $ectID, 47, 56 , 0 )
                              endif
                         endif
				endif
			endif
