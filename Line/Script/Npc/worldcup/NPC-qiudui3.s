	...
	function OnOption0(){
		...
		$num = GetPlayerVar( -1 , 3997 )
		$no1num = GetPlayerVar( -1 , 4030 )
	...
	function OnOption1(){
		...
		//????????4???
		$need = GetPlayerVar( -1 , 3822 )
		//???????4????
		$all = GetPlayerVar( -1 , 3824 )
		...
		$allmoney = $allmoney + $myteam
			...
			//????????????
			SetPlayerVar( -1 , 3822 , $allmoney )
			SetPlayerVar( -1 , 3824 , $allmoney )
			
			//??????****
			SetPlayerVar( -1 , 3281 , 11 )
