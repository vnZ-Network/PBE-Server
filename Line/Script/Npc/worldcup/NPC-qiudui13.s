	...
	function OnOption0(){
		...
		$num = GetPlayerVar( -1 , 4007 )
		$no1num = GetPlayerVar( -1 , 4040 )
	...
	function OnOption1(){
		...
		//????????4???
		$need = GetPlayerVar( -1 , 3826 )
		//???????4????
		$all = GetPlayerVar( -1 , 3827 )
		...
		$allmoney = $allmoney + $myteam
			...
			//????????????
			SetPlayerVar( -1 , 3826 , $allmoney )
			SetPlayerVar( -1 , 3827 , $allmoney )
			
			//??????****
			SetPlayerVar( -1 , 3282 , 11 )
