	...
	function OnOption0(){
		...
		$num = GetPlayerVar( -1 , 4011 )
		$no1num = GetPlayerVar( -1 , 4044 )
	...
	function OnOption1(){
		...
		//????????4???
		$need = GetPlayerVar( -1 , 3828 )
		//???????4????
		$all = GetPlayerVar( -1 , 3829 )
		...
		$allmoney = $allmoney + $myteam
			...
			//????????????
			SetPlayerVar( -1 , 3828 , $allmoney )
			SetPlayerVar( -1 , 3829 , $allmoney )
			
			//??????****
			SetPlayerVar( -1 , 3283 , 11 )
