	...
	function OnOption0(){
		...
		$glod = GetPlayerInfo( -1 , "item",12586)
		$silver = GetPlayerInfo( -1 , "item",12587)
//----------????------start---------------------			
		if $count == 1
			if $task != 0
		...
		if $count > 1
			...
			if $Men1 != -1
				if $id != $Men1
					...
					$glod1 = GetPlayerInfo( $Men1 , "item",12586)
					$silver1 = GetPlayerInfo( $Men1 , "item",12587)
			...
			if $Men2 != -1
				if $id != $Men2
					...
					$glod2 = GetPlayerInfo( $Men2 , "item",12586)
					$silver2 = GetPlayerInfo( $Men2 , "item",12587)
			...
			if $Men3 != -1
				if $id != $Men3
					...
					$glod3 = GetPlayerInfo( $Men3 , "item",12586)
					$silver3 = GetPlayerInfo( $Men3 , "item",12587)
			...
			if $Men4 != -1
				if $id != $Men4
					...
					$glod4 = GetPlayerInfo( $Men4 , "item",12586)
					$silver4 = GetPlayerInfo( $Men4 , "item",12587)
			...
			if $Men5 != -1
				if $id != $Men5
					...
					$glod5 = GetPlayerInfo( $Men5 , "item",12586)
					$silver5 = GetPlayerInfo( $Men5 , "item",12587)
			...
			if $Men6 != -1
				if $id != $Men6
					...
					$glod6 = GetPlayerInfo( $Men6 , "item",12586)
					$silver6 = GetPlayerInfo( $Men6 , "item",12587)
		...
		//---------???--------------
			...
			if $n == 0
				if $Men1 != -1
					...
					$silver1 = GetPlayerInfo( $Men1 , "item",12587) 
					if $glod1 != 0
						AcceptTask($Men1,2141)
						BC( "dialogbox", "player", $Men1, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver1 != 0
							AcceptTask($Men1,2141)
							BC( "dialogbox", "player", $Men1, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
				...
				if $Men2 != -1
					...
					$silver2 = GetPlayerInfo( $Men2 , "item",12587) 
					if $glod2 != 0
						AcceptTask($Men2,2141)
						BC( "dialogbox", "player", $Men2, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver2 != 0
							AcceptTask($Men2,2141)
							BC( "dialogbox", "player", $Men2, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
				...
				if $Men3 != -1
					...
					$silver3 = GetPlayerInfo( $Men3 , "item",12587) 
					if $glod3 != 0
						AcceptTask($Men3,2141)
						BC( "dialogbox", "player", $Men3, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver3 != 0
							AcceptTask($Men3,2141)
							BC( "dialogbox", "player", $Men3, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
				...
				if $Men4 != -1
					...
					$silver4 = GetPlayerInfo( $Men4 , "item",12587) 
					if $glod4 != 0
						AcceptTask($Men4,2141)
						BC( "dialogbox", "player", $Men4, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver4 != 0
							AcceptTask($Men4,2141)
							BC( "dialogbox", "player", $Men4, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
				...
				if $Men5 != -1
					...
					$silver5 = GetPlayerInfo( $Men5 , "item",12587) 
					if $glod5 != 0
						AcceptTask($Men5,2141)
						BC( "dialogbox", "player", $Men5, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver5 != 0
							AcceptTask($Men5,2141)
							BC( "dialogbox", "player", $Men5, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
				...
				if $Men6 != -1
					...
					$silver6 = GetPlayerInfo( $Men6 , "item",12587) 
					if $glod6 != 0
						AcceptTask($Men6,2141)
						BC( "dialogbox", "player", $Men6, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
					else
						if $silver6 != 0
							AcceptTask($Men6,2141)
							BC( "dialogbox", "player", $Men6, "You have taken the trial of the god of wisdom. Reward will be given to you upon the completion of the quest." )
