	...
	//		Modified:2009/05/07
	//		Author:???
	//		TaskName:HD-Pyramid-NPC-1817_1820.s
	//		TaskID:???????
	//
	//****************************************
	...
	function OnOption0(){
		...
		if $teamplayer1_id != -1
			SubPlayerInfo( $teamplayer1_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer1_id, 3659, 201 )
		...
		if $teamplayer2_id != -1
			SubPlayerInfo( $teamplayer2_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer2_id, 3659, 201 )
		...
		if $teamplayer3_id != -1
			SubPlayerInfo( $teamplayer3_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer3_id, 3659, 201 )
		...
		if $teamplayer4_id != -1
			SubPlayerInfo( $teamplayer4_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer4_id, 3659, 201 )
		...
		if $teamplayer5_id != -1
			SubPlayerInfo( $teamplayer5_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer5_id, 3659, 201 )
		...
		if $teamplayer6_id != -1
			SubPlayerInfo( $teamplayer6_id, "item", 50034, -1 )
			SetPlayerVar( $teamplayer6_id, 3659, 201 )
		...
		BC( "chat", "server", -1, "The hero ",#player_name," has lead the party and entered Maze of Mystery Hallucination." )
		BC( "screen", "server", -1, "The hero ",#player_name," has lead the party and entered Maze of Mystery Hallucination." )
		//??-START
